...
export default function JourneyPage() {
  ...
  return (
    <main className="min-h-screen relative bg-cream text-ink">
      {/* Navigation */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-cream text-ink/80 backdrop-blur-md border-b border-rule">
        <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
          <Link
            href="/"
            className="text-ink-2 hover:text-[var(--primary)] transition-colors flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em]"
          >
          ...
          <Link
            href="/articles"
            className="text-ink-2 hover:text-[var(--primary)] transition-colors text-xs font-bold uppercase tracking-[0.16em]"
          >
            Articles
          </Link>
        </div>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center space-y-12">
          <h2 className="text-3xl md:text-4xl font-cormorant font-light text-[#f2f0e9]/90 leading-tight">
          ...
          <div className="relative py-10 px-8 md:px-12">
            {/* Decorative border */}
            <div className="absolute inset-0 border border-rule rounded-2xl"></div>
            {/* Glow */}
            <div className="absolute -inset-px bg-gradient-to-b from-[#8da399]/8 to-transparent rounded-2xl"></div>

            <div className="relative space-y-6">
              <svg className="w-8 h-8 text-sage/50 mx-auto" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
              <p className="text-xl md:text-2xl font-serif font-medium text-[#f2f0e9]/85 leading-relaxed italic">
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="text-center space-y-6 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl md:text-5xl font-cormorant font-light text-ink leading-tight">
              A System Built for Real Life
            </h2>
            <p className="text-ink-2 text-base md:text-lg leading-relaxed font-sans">
          ...
          <div className="text-center">
            <Link
              href="/understand"
              className="inline-flex items-center gap-2 text-xs uppercase font-bold tracking-[0.16em] text-ink-2 hover:text-[var(--primary)] transition-colors border-b border-[var(--text-secondary)]/20 hover:border-[var(--primary)] pb-1"
            >
      ...
      {/* ============================================================ */}
      <section className="py-24 md:py-32 px-6 bg-cream/40">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="card-container flex flex-col items-start text-left space-y-4 h-full border border-rule hover:-translate-y-1 transition-all duration-500">
              <div className="w-12 h-12 bg-sage-dark text-white/10 rounded-full flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              {/* Phase 1 */}
              <div className="bg-cream p-8 rounded-[1.5rem] shadow-sm border border-rule text-center space-y-4 hover:-translate-y-1 transition-all duration-500">
                <div className="w-14 h-14 bg-sage-dark text-white text-white rounded-full flex items-center justify-center mx-auto font-serif font-medium text-xl font-bold shadow-md">
                  1
                </div>
                <p className="text-[10px] font-bold tracking-[0.16em] uppercase text-sage">Days 1–30</p>
                <h3 className="font-serif font-medium text-xl text-ink">Foundations</h3>
                <p className="text-sm text-ink-2 leading-relaxed">
              ...
              <div className="bg-cream p-8 rounded-[1.5rem] shadow-sm border border-rule text-center space-y-4 hover:-translate-y-1 transition-all duration-500">
                ...
                <p className="text-[10px] font-bold tracking-[0.16em] uppercase text-sage">Days 31–60</p>
                <h3 className="font-serif font-medium text-xl text-ink">Deepening</h3>
                <p className="text-sm text-ink-2 leading-relaxed">
              ...
              <div className="bg-cream p-8 rounded-[1.5rem] shadow-sm border border-rule text-center space-y-4 hover:-translate-y-1 transition-all duration-500">
                ...
                <p className="text-[10px] font-bold tracking-[0.16em] uppercase text-sage">Days 61–90</p>
                <h3 className="font-serif font-medium text-xl text-ink">Sustaining</h3>
                <p className="text-sm text-ink-2 leading-relaxed">
      ...
      <section id="final-cta" className="relative py-24 md:py-32 overflow-hidden scroll-mt-16">
        ...
        <div className="relative max-w-2xl mx-auto px-6 text-center space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-5xl font-cormorant font-light text-[#f2f0e9]/90 leading-tight">
              The bedroom is no longer a battlefield.
            </h2>
            <p className="text-[#f2f0e9]/50 text-lg font-serif font-medium italic">
              Call a truce today.
            </p>
          </div>

          {/* Amazon Purchase Block */}
          <div className="bg-[#f2f0e9]/5 border border-[#f2f0e9]/10 rounded-2xl p-8 md:p-10 space-y-6 backdrop-blur-sm mt-8">
            <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#f2f0e9]/90 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 max-w-md mx-auto">
              ...
              <a
                ...
                className="w-full sm:w-auto px-10 py-4 bg-sage-dark text-white text-white rounded-full font-bold uppercase tracking-[0.16em] text-xs shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3 group hover:bg-sage"
              >
      ...
      {/* ============================================================ */}
      <section className="py-16 px-6 bg-cream text-ink">
        <div className="max-w-3xl mx-auto">
          <div className="bg-cream-2 border border-rule rounded-2xl p-6 md:p-8 text-xs text-ink-2 space-y-4 text-left">
            <p className="font-bold text-ink uppercase tracking-[0.16em] text-[11px] mb-4 pb-3 border-b border-rule">
          ...
          <footer className="text-center text-ink-2 opacity-60 text-xs mt-8 py-4 font-sans">
