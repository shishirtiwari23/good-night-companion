    ...
    <main className="min-h-screen flex flex-col items-center p-4 md:p-12 relative bg-cream text-ink">
      ...
      <article className="w-full max-w-3xl z-10 bg-cream p-6 md:p-12 rounded-[2rem] shadow-sm mb-20 shadow-[rgba(0,0,0,0.03)_0px_10px_30px]">
        ...
        <div className="text-ink-2 font-sans leading-relaxed space-y-6 text-lg">
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Biology: The Loss of the Pain Buffer</h2>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Psychology: The Terror of the Symptoms</h2>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">Recovery is Structural, Not Chemical</h2>
