...
const faqs = [
  { question: "What is a good Sleep Efficiency score?", answer: "In clinical sleep medicine, the gold standard target for Sleep Efficiency is 85% to 90%. This means that 85% of the time you spend in bed is spent actually sleeping, resulting in highly consolidated, deep rest without hours of tossing and turning." },
  { question: "How do I calculate my Sleep Efficiency?", answer: "Sleep Efficiency is calculated by dividing your Total Sleep Time by your Time in Bed, and multiplying by 100. For an accurate clinical baseline, you must track these numbers for 7 days and use your weekly averages, rather than panicking over a single bad night." },
  { question: "Why is spending 10 hours in bed bad for insomnia?", answer: "Spending excessive time in bed dilutes your homeostatic sleep pressure (your biological hunger for sleep). If you are only capable of 6 hours of sleep, spreading it across a 10-hour window causes fragmented, low-quality sleep and gives you 4 hours to practice being awake and anxious." },
  { question: "What is the absolute minimum time I should spend in bed?", answer: "Regardless of your Sleep Efficiency math, clinical safety protocols dictate that you should never restrict your sleep window to less than 5.5 hours. This is the absolute clinical safety floor required to maintain core biological functions and daytime safety." }
];
