...
const faqs = [
  { question: "Should I stay in bed if I can't sleep?", answer: "No. Staying in bed while awake, frustrated, and anxious teaches your brain to associate your mattress with stress. This is called Conditioned Hyperarousal. To break this association, you must get out of bed if you haven't fallen asleep after 20 minutes." },
  { question: "What should I do when I get out of bed in the middle of the night?", answer: "Move to a dimly lit room and engage in a calm, boring activity like reading a physical book or listening to a gentle podcast. Avoid screens, as blue light suppresses melatonin, and only return to bed when you feel physically sleepy again." },
  { question: "How do I know if 20 minutes have passed without checking the clock?", answer: "Do not watch the clock, as checking the time triggers adrenaline and sleep anxiety. Instead, simply estimate. Once you feel a heavy wave of frustration, tossing, and turning, assume it has been about 20 minutes and get out of bed." },
  { question: "What if I don't have another room to go to when I can't sleep?", answer: "If you cannot leave your bedroom due to space or caregiving constraints, physically remove yourself from the mattress by moving to a chair or cushion in the room. If you must stay in bed, prop yourself completely upright to signal that you are no longer trying to sleep." }
];
