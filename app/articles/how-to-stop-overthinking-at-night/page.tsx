      ...
      <article className="w-full max-w-3xl z-10 bg-cream p-6 md:p-12 rounded-[2rem] shadow-sm mb-20 shadow-[rgba(0,0,0,0.03)_0px_10px_30px]">
        ...
        <div className="text-ink-2 font-sans leading-relaxed space-y-6 text-lg">
          ...
          <div className="bg-[#f9f8f6] p-6 rounded-[1rem] border border-rule my-6">
            ...
            <p className="font-sans text-ink-2 text-lg">How do you stop overthinking at night? Trying to forcefully "empty your mind" triggers performance anxiety and dumps adrenaline into your system. Instead, use a clinical tool called Cognitive Defusion. By acknowledging your racing thoughts as harmless mental notifications rather than commands you must act on, you remove their power and allow your nervous system to calm down.</p>
          </div>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Irony of Mental Control</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Solution: Cognitive Defusion</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The 3-Step Process: From &quot;Command&quot; to &quot;Notification&quot;</h2>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">When the Mind Won&apos;t Settle: Reframing the Sanctuary</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">Call a Truce</h2>
          <p>
