    ...
    <main className="min-h-screen flex flex-col items-center p-4 md:p-12 relative bg-cream text-ink">
      ...
      <article className="w-full max-w-3xl z-10 bg-cream p-6 md:p-12 rounded-[2rem] shadow-sm mb-20 shadow-[rgba(0,0,0,0.03)_0px_10px_30px]">
        ...
        <div className="text-ink-2 font-sans leading-relaxed space-y-6 text-lg">
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Psychology: The Zeigarnik Effect</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Biology: The Adrenaline Response</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Fix: Closing the Loops (Constructive Worry)</h2>
          <p>
          ...
          <div className="bg-sage-dark text-white/10 p-8 rounded-2xl my-12 border border-[var(--primary)]/20">
            <h3 className="font-serif font-medium text-2xl text-ink mb-4">Get Your Night Back</h3>
            <p className="mb-6">
