    ...
    <main className="min-h-screen flex flex-col items-center p-4 md:p-12 relative bg-cream text-ink">
      ...
      <article className="w-full max-w-3xl z-10 bg-cream p-6 md:p-12 rounded-[2rem] shadow-sm mb-20 shadow-[rgba(0,0,0,0.03)_0px_10px_30px]">
        ...
        <div className="text-ink-2 font-sans leading-relaxed space-y-6 text-lg">
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Neuroscience: Dreaming While Awake</h2>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Safety Framework: When is it an Emergency?</h2>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">Finding the Ground Again</h2>
