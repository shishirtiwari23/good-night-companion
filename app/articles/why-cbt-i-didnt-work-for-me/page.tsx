      ...
      <article className="w-full max-w-3xl z-10 bg-cream p-6 md:p-12 rounded-[2rem] shadow-sm mb-20 shadow-[rgba(0,0,0,0.03)_0px_10px_30px]">
        ...
        <div className="text-ink-2 font-sans leading-relaxed space-y-6 text-lg">
          ...
          <div className="bg-[#f9f8f6] p-6 rounded-[1rem] border border-rule my-6">
            ...
            <p className="font-sans text-ink-2 text-lg">Why does CBT-I sometimes fail? Standard CBT-I is biologically highly effective, but it often fails because it is too rigid. When you aggressively restrict your sleep to build sleep pressure, it temporarily spikes daytime fatigue and anxiety. If you treat the CBT-I rules like a strict test you can fail, your performance anxiety skyrockets. To succeed, CBT-I must be paired with ACT-I (Acceptance and Commitment Therapy) to manage the panic and introduce psychological flexibility.</p>
          </div>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Biology: The Cortisol Spike of Sleep Restriction</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Psychology: The Rigidity Trap</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">The Missing Piece: ACT-I (A Bad Night is Data, Not a Verdict)</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-medium text-ink mt-12 mb-4">Guided Recovery, Not Just Rules</h2>
          <p>
