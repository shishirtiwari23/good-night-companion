        ...
        <div className="text-[var(--text-secondary)] font-sans leading-relaxed space-y-6 text-lg">
          ...
          <div className="my-8 border-l-4 border-[var(--primary)] pl-6 py-4 bg-[#f9f8f6] rounded-r-xl shadow-sm">
            ...
            <p className="italic text-lg text-[var(--text-primary)] m-0">
              &quot;It is 11:30 PM. You did everything right. You took the &apos;extra-strength&apos; 10mg melatonin gummy two hours ago, turned off the lights, and waited. Now, you are lying in the dark experiencing a very specific, chemical kind of hell. Your limbs feel like lead. Your head is swimming in a thick, artificial fog. But your heart is still pounding, and your mind is still racing at 100 miles an hour. You are physically drugged, yet completely, agonizingly awake... When you wake up the next morning feeling like you were hit by a truck, and a coworker cheerfully tells you to &apos;just try a melatonin gummy,&apos; it takes every ounce of willpower not to lose your mind.&quot;
            </p>
          </div>
           <p>
