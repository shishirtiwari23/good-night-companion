...
const PrincipleHeader = ({ num, title, type = "CBT" }: { num: number; title: string; type?: "CBT" | "ACT" }) => (
  <div className="flex items-start mb-6 mt-12">
    <div
      ...
      } font-serif text-lg font-bold mr-4 shadow-sm`}
    >
      {num}
    </div>
    <h3 className="text-2xl md:text-3xl font-serif text-[var(--text-primary)] pt-1">{title}</h3>
  </div>
);

const InsomniaLoopSVG = () => (
  <div className="w-full max-w-xl mx-auto my-16 bg-white/40 p-8 rounded-3xl border border-[#8da399]/20 shadow-sm relative overflow-hidden group">
...
const ProcessChartSVG = () => (
  <div className="w-full my-16 p-8 md:p-12 bg-white/40 rounded-3xl border border-[#8da399]/20 shadow-sm relative overflow-hidden">
    ...
    <div className="flex flex-col md:flex-row gap-12 items-center justify-center relative z-10">
      <div className="w-full md:w-1/2 flex flex-col items-center">
        <h4 className="font-serif text-xl mb-4 text-[var(--text-primary)]">Process S (Sleep Pressure)</h4>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center">
         <h4 className="font-serif text-xl mb-4 text-[var(--text-primary)]">Process C (Circadian Rhythm)</h4>
         <div className="relative w-full max-w-[300px]">
           <svg viewBox="0 0 300 160" className="w-full h-auto">
            {/* axes */}
            <line x1="30" y1="130" x2="280" y2="130" stroke="#8da399" strokeWidth="2" strokeOpacity="0.5" />
...
const SpamFilterQuote = () => (
  <div className="my-14 p-10 border-l-[6px] border-[#7a8f86] bg-gradient-to-r from-[#7a8f86]/10 to-transparent rounded-r-3xl relative">
    <div className="absolute -left-[32px] -top-8 text-8xl text-[#7a8f86] opacity-30 font-serif leading-none">"</div>
    <p className="italic text-[var(--text-primary)] text-xl md:text-2xl font-serif leading-relaxed relative z-10">
...
const SleepEfficiencyFormula = () => (
  <div className="my-16 relative overflow-hidden rounded-3xl bg-white border border-[#8da399]/30 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
    ...
    <div className="bg-[#4a544e] text-white py-5 px-8">
      <h4 className="text-xl font-serif text-white tracking-wide">The Math Behind the Magic: Sleep Efficiency (SE)</h4>
    </div>
    
    <div className="p-8 md:p-12 relative z-10">
      <div className="bg-[#f5f8f6] rounded-2xl border border-[#8da399]/20 p-8 flex flex-col md:flex-row items-center justify-around gap-8 mb-10 shadow-inner">
        <div className="text-center group">
          <span className="block text-sm font-bold text-[#8da399] uppercase tracking-widest mb-3">Clinical Target</span>
          <span className="text-5xl md:text-6xl font-serif text-[#4a544e] transition-transform duration-300 group-hover:scale-105 inline-block">85%+</span>
        </div>
        ...
        <div className="text-center font-sans tracking-wide text-lg md:text-xl text-[#27302a] font-medium leading-relaxed max-w-sm">
           <span className="text-[#4a544e] font-serif text-3xl">SE</span> = <br className="md:hidden" />(Total Sleep Time &divide; Time in Bed) &times; 100
        </div>
      </div>
      
      <div className="space-y-4 max-w-2xl text-[var(--text-secondary)] bg-white mx-auto text-center md:text-left">
        <p className="font-bold text-[var(--text-primary)] text-lg border-b border-gray-100 pb-2">Example Calculation</p>
...
const AlchemyQuote = () => (
  <div className="my-24 py-20 px-6 md:px-16 text-center max-w-5xl mx-auto border-t-2 border-b-2 border-[#8da399]/20 relative bg-gradient-to-b from-transparent via-[#8da399]/5 to-transparent">
    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--background)] p-4 rounded-full border border-[#8da399]/20 shadow-sm text-[#7a8f86]">
    ...
    <h2 className="text-sm font-bold tracking-widest text-[#8da399] uppercase mb-8">The Alchemy of Recovery</h2>
    <p className="text-3xl md:text-4xl lg:text-5xl leading-tight md:leading-[1.4] font-serif text-[var(--text-primary)] px-4 italic">
    ...
    <main className="min-h-screen flex justify-center p-6 md:p-12 pb-24 relative bg-[var(--background)]">
      ...
      <article className="max-w-4xl w-full space-y-16 animate-in fade-in duration-700 mt-12 mb-16">
        ...
        <header className="space-y-8">
          <p className="overline-text opacity-60">The Clinical Deep Dive</p>
          <h1 className="text-4xl md:text-5xl font-serif text-[var(--text-primary)] leading-tight">
            The Science of Sleep Recovery
          </h1>
          <div className="bg-[#f5f8f6] p-6 md:p-8 rounded-2xl border border-[#8da399]/30 shadow-sm space-y-4 text-[var(--text-secondary)] text-lg leading-relaxed">
            <p>
              <strong className="text-[var(--text-primary)]">Who This Page Is For:</strong> If you&apos;ve tried sleep hygiene, apps, and generic CBT-I worksheets and still can&apos;t sleep, this page explains the clinical science behind why those approaches failed—and what actually works. You'll walk away understanding exactly how The Goodnight Companion rebuilds your sleep architecture, step by step.
            </p>
          </div>
          
          <div className="space-y-6 text-lg text-[var(--text-secondary)] leading-relaxed font-sans mt-8">
            <p>
        ...
        <section>
          <div className="border-b-2 border-gray-200 pb-4 mb-8">
            <h2 className="text-3xl md:text-4xl font-serif text-[var(--text-primary)]">
              Part I: The Biological Hardware <br className="md:hidden" />
              <span className="text-xl md:text-2xl text-[#8da399] tracking-wider uppercase font-sans mt-2 block">(CBT-I Mechanics)</span>
            </h2>
          </div>
          ...
          <div className="space-y-16">
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                <p>
                  <strong className="text-[var(--text-primary)] block mb-1">The Science:</strong>
                ...
                <p>
                  <strong className="text-[var(--text-primary)] block mb-1">The Fix:</strong>
                ...
                <p>
                  <strong className="text-[var(--text-primary)] block mb-1">The Analogy:</strong>
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Spielman, A. J., Saskin, P., & Thorpy, M. J. (1987). Treatment of chronic insomnia by restriction of time in bed. Sleep, 10(1), 45-56.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Czeisler, C. A., et al. (1989). Bright light resets the human circadian pacemaker independent of the timing of the sleep-wake cycle. Science, 244(4910), 1328-1333.</p>
              </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Bootzin, R. R. (1972). Stimulus control treatment for insomnia. Proceedings of the American Psychological Association.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Harvey, A. G. (2002). A cognitive model of insomnia. Behaviour Research and Therapy, 40(8), 869-893.</p>
              </div>
            </div>
        ...
        <section className="my-16 p-8 bg-[var(--primary)] text-white rounded-3xl shadow-lg relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-10">
            <svg width="100" height="100" viewBox="0 0 24 24" fill="currentColor">
               <path d="M12 2L15 8L21 9L16.5 14L18 20L12 17L6 20L7.5 14L3 9L9 8L12 2Z" />
            </svg>
          </div>
          <div className="relative z-10 text-lg md:text-xl leading-relaxed font-serif text-white/90">
        ...
        {/* Part II: ACT-I */}
        <section>
          <div className="border-b-2 border-gray-200 pb-4 mb-8 mt-16">
            <h2 className="text-3xl md:text-4xl font-serif text-[var(--text-primary)]">
          ...
          <div className="space-y-16">
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Ascher, L. M., & Efran, J. S. (1978). Use of paradoxical intention in a behavioral program for sleep onset insomnia. Journal of Consulting and Clinical Psychology, 46(3), 547-550.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: Ong, J. C., Ulmer, C. S., & Manber, R. (2012). Improving sleep with mindfulness and acceptance: a metacognitive model of insomnia. Behaviour Research and Therapy, 50(11), 651-660.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
                ...
                <p>
                  <strong className="text-[var(--text-primary)] block mb-1">The Application:</strong>
                ...
                <p className="text-sm text-gray-500 italic mt-4">Reference: McCracken, L. M., & Vowles, K. E. (2014). Acceptance and commitment therapy and mindfulness for chronic pain: Model, process, and progress. American Psychologist, 69(2), 178-187.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="pt-10">
          ...
          <p className="text-sm text-gray-500 italic mt-4 text-center md:text-left max-w-2xl mx-auto md:ml-12 pl-4">
        ...
        <section>
          ...
          <div className="space-y-6 text-lg text-[var(--text-secondary)] leading-relaxed text-center max-w-3xl mx-auto">
            <p>
